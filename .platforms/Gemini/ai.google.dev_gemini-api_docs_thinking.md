...
[Sign in](https://ai.google.dev/_d/signin?continue=https%3A%2F%2Fai.google.dev%2Fgemini-api%2Fdocs%2Fthinking&prompt=select_account)

- On this page
- [Generating content with thinking](https://ai.google.dev/gemini-api/docs/thinking#generating-content-with-thinking)
- [Thought summaries](https://ai.google.dev/gemini-api/docs/thinking#summaries)
- [Controlling thinking](https://ai.google.dev/gemini-api/docs/thinking#levels-budgets)
  - [Thinking levels (Gemini 3)](https://ai.google.dev/gemini-api/docs/thinking#thinking-levels)
...
- [Supported models, tools, and capabilities](https://ai.google.dev/gemini-api/docs/thinking#tools)
...
[Python](https://ai.google.dev/gemini-api/docs/thinking#python)[JavaScript](https://ai.google.dev/gemini-api/docs/thinking#javascript)[Go](https://ai.google.dev/gemini-api/docs/thinking#go)More
...
| Model | Default setting<br>(Thinking budget is not set) | Range | Disable thinking | Turn on dynamic thinking |
| --- | --- | --- | --- | --- |
...
the request includes [function calling](https://ai.google.dev/gemini-api/docs/function-calling#thinking),
specifically [function declarations](https://ai.google.dev/gemini-api/docs/function-calling#step-2).
