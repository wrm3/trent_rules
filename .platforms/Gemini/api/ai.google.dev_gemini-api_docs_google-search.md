[Skip to main content](https://ai.google.dev/gemini-api/docs/google-search#main-content)
...
- [Supported tools combinations](https://ai.google.dev/gemini-api/docs/google-search#supported_tools_combinations)
