...
- On this page
- [Passing PDF data inline](https://ai.google.dev/gemini-api/docs/document-processing#inline_data)
- [Uploading PDFs using the Files API](https://ai.google.dev/gemini-api/docs/document-processing#large-pdfs)
...
- [Technical details](https://ai.google.dev/gemini-api/docs/document-processing#technical-details)
  - [Gemini 3 models](https://ai.google.dev/gemini-api/docs/document-processing#gemini-3-models)
