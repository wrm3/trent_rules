...
- On this page
- [Single-speaker TTS](https://ai.google.dev/gemini-api/docs/speech-generation#single-speaker)
- [Multi-speaker TTS](https://ai.google.dev/gemini-api/docs/speech-generation#multi-speaker)
...
- [Prompting guide](https://ai.google.dev/gemini-api/docs/speech-generation#prompting-guide)
  - [Prompting structure](https://ai.google.dev/gemini-api/docs/speech-generation#prompt-structure)
  - [Detailed Prompting Strategies](https://ai.google.dev/gemini-api/docs/speech-generation#prompting-strategies)
...
- A TTS session has a [context window](https://ai.google.dev/gemini-api/docs/long-context) limit of
32k tokens.
...
directorial prompts align, _so that "who is saying it"_ matches with _"what is_
_said"_ and _"how it is being said."_
...
provide as much detail as necessary: _"Infectious enthusiasm. The listener_
_should feel like they are part of a massive, exciting community event."_ works
...
results are. For example use " _British English accent as heard in Croydon,_
_England_" vs " _British Accent_".
