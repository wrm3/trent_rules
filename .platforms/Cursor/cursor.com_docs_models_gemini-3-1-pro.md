[Skip to main content](https://cursor.com/docs/models/gemini-3-1-pro#main-content)
...
![Google](https://cursor.com/docs-static/images/providers/google.svg)
...
## [Strengths](https://cursor.com/docs/models/gemini-3-1-pro\#strengths)
...
## [Tools](https://cursor.com/docs/models/gemini-3-1-pro\#tools)
...
## [Pricing](https://cursor.com/docs/models/gemini-3-1-pro\#pricing)

Cursor [plans](https://cursor.com/docs/models-and-pricing) include two usage pools. Gemini 3.1 Pro draws from the **API** pool, which charges at the rates below. Individual plans include at least $20 of API usage each month (more on higher tiers). All prices are per million tokens.
