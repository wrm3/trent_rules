...
- [4\. Pin model versions](https://code.claude.com/docs/en/azure-ai-foundry#4-pin-model-versions)
...
## [​](https://code.claude.com/docs/en/azure-ai-foundry\#prerequisites)  Prerequisites
...
If you are deploying Claude Code to multiple users, [pin your model versions](https://code.claude.com/docs/en/azure-ai-foundry#4-pin-model-versions) to prevent breakage when Anthropic releases new models.

## [​](https://code.claude.com/docs/en/azure-ai-foundry\#setup)  Setup

### [​](https://code.claude.com/docs/en/azure-ai-foundry\#1-provision-microsoft-foundry-resource)  1\. Provision Microsoft Foundry resource
...
### [​](https://code.claude.com/docs/en/azure-ai-foundry\#2-configure-azure-credentials)  2\. Configure Azure credentials
...
### [​](https://code.claude.com/docs/en/azure-ai-foundry\#3-configure-claude-code)  3\. Configure Claude Code
...
### [​](https://code.claude.com/docs/en/azure-ai-foundry\#4-pin-model-versions)  4\. Pin model versions
...
## [​](https://code.claude.com/docs/en/azure-ai-foundry\#azure-rbac-configuration)  Azure RBAC configuration
...
## [​](https://code.claude.com/docs/en/azure-ai-foundry\#troubleshooting)  Troubleshooting
...
## [​](https://code.claude.com/docs/en/azure-ai-foundry\#additional-resources)  Additional resources
