...
Another option to disable fast mode entirely is to set `CLAUDE_CODE_DISABLE_FAST_MODE=1`. See [Environment variables](https://code.claude.com/docs/en/settings#environment-variables).
...
[Model configuration](https://code.claude.com/docs/en/model-config) [Customize status line](https://code.claude.com/docs/en/statusline)
