[Skip to content](https://code.claude.com/docs/en/changelog#start-of-content)

You signed in with another tab or window. [Reload](https://code.claude.com/docs/en/changelog) to refresh your session.You signed out in another tab or window. [Reload](https://code.claude.com/docs/en/changelog) to refresh your session.You switched accounts on another tab or window. [Reload](https://code.claude.com/docs/en/changelog) to refresh your session.Dismiss alert

{{ message }}

[anthropics](https://code.claude.com/anthropics)/ **[claude-code](https://code.claude.com/anthropics/claude-code)** Public
...
[History](https://code.claude.com/anthropics/claude-code/commits/main/CHANGELOG.md)

[View commit history for this file.](https://code.claude.com/anthropics/claude-code/commits/main/CHANGELOG.md) History

2132 lines (1662 loc) · 133 KB
...
[Raw](https://github.com/anthropics/claude-code/raw/refs/heads/main/CHANGELOG.md)
...
[Permalink: Changelog](https://code.claude.com/docs/en/changelog#changelog)

## 2.1.71

[Permalink: 2.1.71](https://code.claude.com/docs/en/changelog#2171)
...
[Permalink: 2.1.70](https://code.claude.com/docs/en/changelog#2170)
...
[Permalink: 2.1.69](https://code.claude.com/docs/en/changelog#2169)
...
## 2.1.68\
\
[Permalink: 2.1.68](https://code.claude.com/docs/en/changelog#2168)\
\
...
## 2.1.66\
\
[Permalink: 2.1.66](https://code.claude.com/docs/en/changelog#2166)\
\
- Reduced spurious error logging\
\
## 2.1.63\
\
[Permalink: 2.1.63](https://code.claude.com/docs/en/changelog#2163)\
\
...
## 2.1.62\
\
[Permalink: 2.1.62](https://code.claude.com/docs/en/changelog#2162)\
\
- Fixed prompt suggestion cache regression that reduced cache hit rates\
\
## 2.1.61\
\
[Permalink: 2.1.61](https://code.claude.com/docs/en/changelog#2161)\
\
- Fixed concurrent writes corrupting config file on Windows\
\
## 2.1.59\
\
[Permalink: 2.1.59](https://code.claude.com/docs/en/changelog#2159)\
\
...
## 2.1.58\
\
[Permalink: 2.1.58](https://code.claude.com/docs/en/changelog#2158)\
\
- Expand Remote Control to more users\
\
## 2.1.56\
\
[Permalink: 2.1.56](https://code.claude.com/docs/en/changelog#2156)\
\
- VS Code: Fixed another cause of "command 'claude-vscode.editor.openLast' not found" crashes\
\
## 2.1.55\
\
[Permalink: 2.1.55](https://code.claude.com/docs/en/changelog#2155)\
\
- Fixed BashTool failing on Windows with EINVAL error\
\
## 2.1.53\
\
[Permalink: 2.1.53](https://code.claude.com/docs/en/changelog#2153)\
\
...
## 2.1.52\
\
[Permalink: 2.1.52](https://code.claude.com/docs/en/changelog#2152)\
\
- VS Code: Fixed extension crash on Windows ("command 'claude-vscode.editor.openLast' not found")\
\
## 2.1.51\
\
[Permalink: 2.1.51](https://code.claude.com/docs/en/changelog#2151)\
\
...
## 2.1.50\
\
[Permalink: 2.1.50](https://code.claude.com/docs/en/changelog#2150)\
\
...
## 2.1.49\
\
[Permalink: 2.1.49](https://code.claude.com/docs/en/changelog#2149)\
\
...
## 2.1.47\
\
[Permalink: 2.1.47](https://code.claude.com/docs/en/changelog#2147)\
\
...
- Fixed compaction failing when conversation contains many PDF documents by stripping document blocks alongside images before sending to the compaction API ( [#26188](https://github.com/anthropics/claude-code/issues/26188))\
...
- Fixed user-defined agents only loading one file on NFS/FUSE filesystems that report zero inodes ( [#26044](https://github.com/anthropics/claude-code/issues/26044))\
- Fixed plugin agent skills silently failing to load when referenced by bare name instead of fully-qualified plugin name ( [#25834](https://github.com/anthropics/claude-code/issues/25834))\
- Search patterns in collapsed tool results are now displayed in quotes for clarity\
- Windows: Fixed CWD tracking temp files never being cleaned up, causing them to accumulate indefinitely ( [#17600](https://github.com/anthropics/claude-code/issues/17600))\
...
- Fixed custom session titles set via `/rename` being lost after resuming a conversation ( [#23610](https://github.com/anthropics/claude-code/issues/23610))\
...
- Fixed built-in slash commands (`/help`, `/model`, `/compact`, etc.) being hidden from the autocomplete dropdown when many user skills are installed ( [#22020](https://github.com/anthropics/claude-code/issues/22020))\
- Fixed MCP servers not appearing in the MCP Management Dialog after deferred loading\
- Fixed session name persisting in status bar after `/clear` command ( [#26082](https://github.com/anthropics/claude-code/issues/26082))\
- Fixed crash when a skill's `name` or `description` in SKILL.md frontmatter is a bare number (e.g., `name: 3000`) — the value is now properly coerced to a string ( [#25837](https://github.com/anthropics/claude-code/issues/25837))\
- Fixed /resume silently dropping sessions when the first message exceeds 16KB or uses array-format content ( [#25721](https://github.com/anthropics/claude-code/issues/25721))\
- Added `chat:newline` keybinding action for configurable multi-line input ( [#26075](https://github.com/anthropics/claude-code/issues/26075))\
- Added `added_dirs` to the statusline JSON `workspace` section, exposing directories added via `/add-dir` to external scripts ( [#26096](https://github.com/anthropics/claude-code/issues/26096))\
- Fixed `claude doctor` misclassifying mise and asdf-managed installations as native installs ( [#26033](https://github.com/anthropics/claude-code/issues/26033))\
- Fixed zsh heredoc failing with "read-only file system" error in sandboxed commands ( [#25990](https://github.com/anthropics/claude-code/issues/25990))\
- Fixed agent progress indicator showing inflated tool use count ( [#26023](https://github.com/anthropics/claude-code/issues/26023))\
- Fixed image pasting not working on WSL2 systems where Windows copies images as BMP format ( [#25935](https://github.com/anthropics/claude-code/issues/25935))\
- Fixed background agent results returning raw transcript data instead of the agent's final answer ( [#26012](https://github.com/anthropics/claude-code/issues/26012))\
- Fixed Warp terminal incorrectly prompting for Shift+Enter setup when it supports it natively ( [#25957](https://github.com/anthropics/claude-code/issues/25957))\
- Fixed CJK wide characters causing misaligned timestamps and layout elements in the TUI ( [#26084](https://github.com/anthropics/claude-code/issues/26084))\
- Fixed custom agent `model` field in `.claude/agents/*.md` being ignored when spawning team teammates ( [#26064](https://github.com/anthropics/claude-code/issues/26064))\
- Fixed plan mode being lost after context compaction, causing the model to switch from planning to implementation mode ( [#26061](https://github.com/anthropics/claude-code/issues/26061))\
- Fixed `alwaysThinkingEnabled: true` in settings.json not enabling thinking mode on Bedrock and Vertex providers ( [#26074](https://github.com/anthropics/claude-code/issues/26074))\
- Fixed `tool_decision` OTel telemetry event not being emitted in headless/SDK mode ( [#26059](https://github.com/anthropics/claude-code/issues/26059))\
- Fixed session name being lost after context compaction — renamed sessions now preserve their custom title through compaction ( [#26121](https://github.com/anthropics/claude-code/issues/26121))\
- Increased initial session count in resume picker from 10 to 50 for faster session discovery ( [#26123](https://github.com/anthropics/claude-code/issues/26123))\
- Windows: fixed worktree session matching when drive letter casing differs ( [#26123](https://github.com/anthropics/claude-code/issues/26123))\
- Fixed `/resume <session-id>` failing to find sessions whose first message exceeds 16KB ( [#25920](https://github.com/anthropics/claude-code/issues/25920))\
- Fixed "Always allow" on multiline bash commands creating invalid permission patterns that corrupt settings ( [#25909](https://github.com/anthropics/claude-code/issues/25909))\
- Fixed React crash (error #31) when a skill's `argument-hint` in SKILL.md frontmatter uses YAML sequence syntax (e.g., `[topic: foo | bar]`) — the value is now properly coerced to a string ( [#25826](https://github.com/anthropics/claude-code/issues/25826))\
- Fixed crash when using `/fork` on sessions that used web search — null entries in search results from transcript deserialization are now handled gracefully ( [#25811](https://github.com/anthropics/claude-code/issues/25811))\
- Fixed read-only git commands triggering FSEvents file watcher loops on macOS by adding --no-optional-locks flag ( [#25750](https://github.com/anthropics/claude-code/issues/25750))\
- Fixed custom agents and skills not being discovered when running from a git worktree — project-level `.claude/agents/` and `.claude/skills/` from the main repository are now included ( [#25816](https://github.com/anthropics/claude-code/issues/25816))\
- Fixed non-interactive subcommands like `claude doctor` and `claude plugin validate` being blocked inside nested Claude sessions ( [#25803](https://github.com/anthropics/claude-code/issues/25803))\
- Windows: Fixed the same CLAUDE.md file being loaded twice when drive letter casing differs between paths ( [#25756](https://github.com/anthropics/claude-code/issues/25756))\
- Fixed inline code spans in markdown being incorrectly parsed as bash commands ( [#25792](https://github.com/anthropics/claude-code/issues/25792))\
- Fixed teammate spinners not respecting custom spinnerVerbs from settings ( [#25748](https://github.com/anthropics/claude-code/issues/25748))\
- Fixed shell commands permanently failing after a command deletes its own working directory ( [#26136](https://github.com/anthropics/claude-code/issues/26136))\
- Fixed hooks (PreToolUse, PostToolUse) silently failing to execute on Windows by using Git Bash instead of cmd.exe ( [#25981](https://github.com/anthropics/claude-code/issues/25981))\
- Fixed LSP `findReferences` and other location-based operations returning results from gitignored files (e.g., `node_modules/`, `venv/`) ( [#26051](https://github.com/anthropics/claude-code/issues/26051))\
- Moved config backup files from home directory root to `~/.claude/backups/` to reduce home directory clutter ( [#26130](https://github.com/anthropics/claude-code/issues/26130))\
- Fixed sessions with large first prompts (>16KB) disappearing from the /resume list ( [#26140](https://github.com/anthropics/claude-code/issues/26140))\
- Fixed shell functions with double-underscore prefixes (e.g., `__git_ps1`) not being preserved across shell sessions ( [#25824](https://github.com/anthropics/claude-code/issues/25824))\
- Fixed spinner showing "0 tokens" counter before any tokens have been received ( [#26105](https://github.com/anthropics/claude-code/issues/26105))\
- VSCode: Fixed conversation messages appearing dimmed while the AskUserQuestion dialog is open ( [#26078](https://github.com/anthropics/claude-code/issues/26078))\
- Fixed background tasks failing in git worktrees due to remote URL resolution reading from worktree-specific gitdir instead of the main repository config ( [#26065](https://github.com/anthropics/claude-code/issues/26065))\
- Fixed Right Alt key leaving visible `[25~` escape sequence residue in the input field on Windows/Git Bash terminals ( [#25943](https://github.com/anthropics/claude-code/issues/25943))\
- The `/rename` command now updates the terminal tab title by default ( [#25789](https://github.com/anthropics/claude-code/issues/25789))\
- Fixed Edit tool silently corrupting Unicode curly quotes (\\u201c\\u201d \\u2018\\u2019) by replacing them with straight quotes when making edits ( [#26141](https://github.com/anthropics/claude-code/issues/26141))\
- Fixed OSC 8 hyperlinks only being clickable on the first line when link text wraps across multiple terminal lines.\
\
## 2.1.46\
\
[Permalink: 2.1.46](https://code.claude.com/docs/en/changelog#2146)\
\
...
## 2.1.45\
\
[Permalink: 2.1.45](https://code.claude.com/docs/en/changelog#2145)\
\
...
- Fixed Agent Teams teammates failing on Bedrock, Vertex, and Foundry by propagating API provider environment variables to tmux-spawned processes ( [#23561](https://github.com/anthropics/claude-code/issues/23561))\
- Fixed sandbox "operation not permitted" errors when writing temporary files on macOS by using the correct per-user temp directory ( [#21654](https://github.com/anthropics/claude-code/issues/21654))\
- Fixed Task tool (backgrounded agents) crashing with a `ReferenceError` on completion ( [#22087](https://github.com/anthropics/claude-code/issues/22087))\
...
## 2.1.44\
\
[Permalink: 2.1.44](https://code.claude.com/docs/en/changelog#2144)\
\
...
## 2.1.43\
\
[Permalink: 2.1.43](https://code.claude.com/docs/en/changelog#2143)\
\
...
## 2.1.42\
\
[Permalink: 2.1.42](https://code.claude.com/docs/en/changelog#2142)\
\
...
## 2.1.41\
\
[Permalink: 2.1.41](https://code.claude.com/docs/en/changelog#2141)\
\
...
## 2.1.39\
\
[Permalink: 2.1.39](https://code.claude.com/docs/en/changelog#2139)\
\
...
## 2.1.38\
\
[Permalink: 2.1.38](https://code.claude.com/docs/en/changelog#2138)\
\
...
## 2.1.37\
\
[Permalink: 2.1.37](https://code.claude.com/docs/en/changelog#2137)\
\
- Fixed an issue where /fast was not immediately available after enabling /extra-usage\
\
## 2.1.36\
\
[Permalink: 2.1.36](https://code.claude.com/docs/en/changelog#2136)\
\
...
## 2.1.34\
\
[Permalink: 2.1.34](https://code.claude.com/docs/en/changelog#2134)\
\
...
## 2.1.33\
\
[Permalink: 2.1.33](https://code.claude.com/docs/en/changelog#2133)\
\
...
## 2.1.32\
\
[Permalink: 2.1.32](https://code.claude.com/docs/en/changelog#2132)\
\
...
## 2.1.31\
\
[Permalink: 2.1.31](https://code.claude.com/docs/en/changelog#2131)\
\
...
## 2.1.30\
\
[Permalink: 2.1.30](https://code.claude.com/docs/en/changelog#2130)\
\
...
## 2.1.29\
\
[Permalink: 2.1.29](https://code.claude.com/docs/en/changelog#2129)\
\
- Fixed startup performance issues when resuming sessions that have `saved_hook_context`\
\
## 2.1.27\
\
[Permalink: 2.1.27](https://code.claude.com/docs/en/changelog#2127)\
\
...
## 2.1.25\
\
[Permalink: 2.1.25](https://code.claude.com/docs/en/changelog#2125)\
\
...
## 2.1.23\
\
[Permalink: 2.1.23](https://code.claude.com/docs/en/changelog#2123)\
\
...
## 2.1.22\
\
[Permalink: 2.1.22](https://code.claude.com/docs/en/changelog#2122)\
\
- Fixed structured outputs for non-interactive (-p) mode\
\
## 2.1.21\
\
[Permalink: 2.1.21](https://code.claude.com/docs/en/changelog#2121)\
\
...
## 2.1.20\
\
[Permalink: 2.1.20](https://code.claude.com/docs/en/changelog#2120)\
\
...
## 2.1.19\
\
[Permalink: 2.1.19](https://code.claude.com/docs/en/changelog#2119)\
\
...
## 2.1.18\
\
[Permalink: 2.1.18](https://code.claude.com/docs/en/changelog#2118)\
\
...
## 2.1.17\
\
[Permalink: 2.1.17](https://code.claude.com/docs/en/changelog#2117)\
\
- Fixed crashes on processors without AVX instruction support\
\
## 2.1.16\
\
[Permalink: 2.1.16](https://code.claude.com/docs/en/changelog#2116)\
\
...
## 2.1.15\
\
[Permalink: 2.1.15](https://code.claude.com/docs/en/changelog#2115)\
\
...
## 2.1.14\
\
[Permalink: 2.1.14](https://code.claude.com/docs/en/changelog#2114)\
\
...
## 2.1.12\
\
[Permalink: 2.1.12](https://code.claude.com/docs/en/changelog#2112)\
\
- Fixed message rendering bug\
\
## 2.1.11\
\
[Permalink: 2.1.11](https://code.claude.com/docs/en/changelog#2111)\
\
- Fixed excessive MCP connection requests for HTTP/SSE transports\
\
## 2.1.10\
\
[Permalink: 2.1.10](https://code.claude.com/docs/en/changelog#2110)\
\
...
## 2.1.9\
\
[Permalink: 2.1.9](https://code.claude.com/docs/en/changelog#219)\
\
...
## 2.1.7\
\
[Permalink: 2.1.7](https://code.claude.com/docs/en/changelog#217)\
\
...
## 2.1.6\
\
[Permalink: 2.1.6](https://code.claude.com/docs/en/changelog#216)\
\
...
## 2.1.5\
\
[Permalink: 2.1.5](https://code.claude.com/docs/en/changelog#215)\
\
...
## 2.1.4\
\
[Permalink: 2.1.4](https://code.claude.com/docs/en/changelog#214)\
\
...
## 2.1.3\
\
[Permalink: 2.1.3](https://code.claude.com/docs/en/changelog#213)\
\
...
## 2.1.2\
\
[Permalink: 2.1.2](https://code.claude.com/docs/en/changelog#212)\
\
...
## 2.1.0\
\
[Permalink: 2.1.0](https://code.claude.com/docs/en/changelog#210)\
\
...
## 2.0.76\
\
[Permalink: 2.0.76](https://code.claude.com/docs/en/changelog#2076)\
\
- Fixed issue with macOS code-sign warning when using Claude in Chrome integration\
\
## 2.0.75\
\
[Permalink: 2.0.75](https://code.claude.com/docs/en/changelog#2075)\
\
- Minor bugfixes\
\
## 2.0.74\
\
[Permalink: 2.0.74](https://code.claude.com/docs/en/changelog#2074)\
\
...
## 2.0.73\
\
[Permalink: 2.0.73](https://code.claude.com/docs/en/changelog#2073)\
\
...
## 2.0.72\
\
[Permalink: 2.0.72](https://code.claude.com/docs/en/changelog#2072)\
\
...
## 2.0.71\
\
[Permalink: 2.0.71](https://code.claude.com/docs/en/changelog#2071)\
\
...
## 2.0.70\
\
[Permalink: 2.0.70](https://code.claude.com/docs/en/changelog#2070)\
\
...
## 2.0.69\
\
[Permalink: 2.0.69](https://code.claude.com/docs/en/changelog#2069)\
\
- Minor bugfixes\
\
## 2.0.68\
\
[Permalink: 2.0.68](https://code.claude.com/docs/en/changelog#2068)\
\
...
## 2.0.67\
\
[Permalink: 2.0.67](https://code.claude.com/docs/en/changelog#2067)\
\
...
## 2.0.65\
\
[Permalink: 2.0.65](https://code.claude.com/docs/en/changelog#2065)\
\
...
## 2.0.64\
\
[Permalink: 2.0.64](https://code.claude.com/docs/en/changelog#2064)\
\
...
## 2.0.62\
\
[Permalink: 2.0.62](https://code.claude.com/docs/en/changelog#2062)\
\
...
## 2.0.61\
\
[Permalink: 2.0.61](https://code.claude.com/docs/en/changelog#2061)\
\
- Reverted VSCode support for multiple terminal clients due to responsiveness issues.\
\
## 2.0.60\
\
[Permalink: 2.0.60](https://code.claude.com/docs/en/changelog#2060)\
\
...
## 2.0.59\
\
[Permalink: 2.0.59](https://code.claude.com/docs/en/changelog#2059)\
\
...
## 2.0.58\
\
[Permalink: 2.0.58](https://code.claude.com/docs/en/changelog#2058)\
\
...
## 2.0.57\
\
[Permalink: 2.0.57](https://code.claude.com/docs/en/changelog#2057)\
\
...
## 2.0.56\
\
[Permalink: 2.0.56](https://code.claude.com/docs/en/changelog#2056)\
\
...
## 2.0.55\
\
[Permalink: 2.0.55](https://code.claude.com/docs/en/changelog#2055)\
\
...
## 2.0.54\
\
[Permalink: 2.0.54](https://code.claude.com/docs/en/changelog#2054)\
\
...
## 2.0.52\
\
[Permalink: 2.0.52](https://code.claude.com/docs/en/changelog#2052)\
\
...
## 2.0.51\
\
[Permalink: 2.0.51](https://code.claude.com/docs/en/changelog#2051)\
\
...
## 2.0.50\
\
[Permalink: 2.0.50](https://code.claude.com/docs/en/changelog#2050)\
\
...
## 2.0.49\
\
[Permalink: 2.0.49](https://code.claude.com/docs/en/changelog#2049)\
\
...
## 2.0.47\
\
[Permalink: 2.0.47](https://code.claude.com/docs/en/changelog#2047)\
\
...
## 2.0.46\
\
[Permalink: 2.0.46](https://code.claude.com/docs/en/changelog#2046)\
\
- Fixed image files being reported with incorrect media type when format cannot be detected from metadata\
\
## 2.0.45\
\
[Permalink: 2.0.45](https://code.claude.com/docs/en/changelog#2045)\
\
...
## 2.0.43\
\
[Permalink: 2.0.43](https://code.claude.com/docs/en/changelog#2043)\
\
...
## 2.0.42\
\
[Permalink: 2.0.42](https://code.claude.com/docs/en/changelog#2042)\
\
- Added `agent_id` and `agent_transcript_path` fields to `SubagentStop` hooks.\
\
## 2.0.41\
\
[Permalink: 2.0.41](https://code.claude.com/docs/en/changelog#2041)\
\
...
## 2.0.37\
\
[Permalink: 2.0.37](https://code.claude.com/docs/en/changelog#2037)\
\
...
## 2.0.36\
\
[Permalink: 2.0.36](https://code.claude.com/docs/en/changelog#2036)\
\
...
## 2.0.35\
\
[Permalink: 2.0.35](https://code.claude.com/docs/en/changelog#2035)\
\
...
## 2.0.34\
\
[Permalink: 2.0.34](https://code.claude.com/docs/en/changelog#2034)\
\
...
## 2.0.33\
\
[Permalink: 2.0.33](https://code.claude.com/docs/en/changelog#2033)\
\
...
## 2.0.32\
\
[Permalink: 2.0.32](https://code.claude.com/docs/en/changelog#2032)\
\
...
## 2.0.31\
\
[Permalink: 2.0.31](https://code.claude.com/docs/en/changelog#2031)\
\
...
## 2.0.30\
\
[Permalink: 2.0.30](https://code.claude.com/docs/en/changelog#2030)\
\
...
## 2.0.28\
\
[Permalink: 2.0.28](https://code.claude.com/docs/en/changelog#2028)\
\
...
## 2.0.27\
\
[Permalink: 2.0.27](https://code.claude.com/docs/en/changelog#2027)\
\
...
## 2.0.25\
\
[Permalink: 2.0.25](https://code.claude.com/docs/en/changelog#2025)\
\
...
## 2.0.24\
\
[Permalink: 2.0.24](https://code.claude.com/docs/en/changelog#2024)\
\
...
## 2.0.22\
\
[Permalink: 2.0.22](https://code.claude.com/docs/en/changelog#2022)\
\
...
## 2.0.21\
\
[Permalink: 2.0.21](https://code.claude.com/docs/en/changelog#2021)\
\
...
## 2.0.20\
\
[Permalink: 2.0.20](https://code.claude.com/docs/en/changelog#2020)\
\
- Added support for Claude Skills\
\
## 2.0.19\
\
[Permalink: 2.0.19](https://code.claude.com/docs/en/changelog#2019)\
\
...
## 2.0.17\
\
[Permalink: 2.0.17](https://code.claude.com/docs/en/changelog#2017)\
\
...
## 2.0.15\
\
[Permalink: 2.0.15](https://code.claude.com/docs/en/changelog#2015)\
\
...
## 2.0.14\
\
[Permalink: 2.0.14](https://code.claude.com/docs/en/changelog#2014)\
\
...
## 2.0.13\
\
[Permalink: 2.0.13](https://code.claude.com/docs/en/changelog#2013)\
\
- Fixed `/plugin` not working on native build\
\
## 2.0.12\
\
[Permalink: 2.0.12](https://code.claude.com/docs/en/changelog#2012)\
\
...
## 2.0.11\
\
[Permalink: 2.0.11](https://code.claude.com/docs/en/changelog#2011)\
\
...
## 2.0.10\
\
[Permalink: 2.0.10](https://code.claude.com/docs/en/changelog#2010)\
\
...
## 2.0.9\
\
[Permalink: 2.0.9](https://code.claude.com/docs/en/changelog#209)\
\
- Fix regression where bash backgrounding stopped working\
\
## 2.0.8\
\
[Permalink: 2.0.8](https://code.claude.com/docs/en/changelog#208)\
\
...
## 2.0.5\
\
[Permalink: 2.0.5](https://code.claude.com/docs/en/changelog#205)\
\
...
## 2.0.1\
\
[Permalink: 2.0.1](https://code.claude.com/docs/en/changelog#201)\
\
...
## 2.0.0\
\
[Permalink: 2.0.0](https://code.claude.com/docs/en/changelog#200)\
\
...
## 1.0.126\
\
[Permalink: 1.0.126](https://code.claude.com/docs/en/changelog#10126)\
\
...
## 1.0.124\
\
[Permalink: 1.0.124](https://code.claude.com/docs/en/changelog#10124)\
\
...
## 1.0.123\
\
[Permalink: 1.0.123](https://code.claude.com/docs/en/changelog#10123)\
\
...
## 1.0.120\
\
[Permalink: 1.0.120](https://code.claude.com/docs/en/changelog#10120)\
\
...
## 1.0.119\
\
[Permalink: 1.0.119](https://code.claude.com/docs/en/changelog#10119)\
\
...
## 1.0.117\
\
[Permalink: 1.0.117](https://code.claude.com/docs/en/changelog#10117)\
\
...
## 1.0.115\
\
[Permalink: 1.0.115](https://code.claude.com/docs/en/changelog#10115)\
\
...
## 1.0.113\
\
[Permalink: 1.0.113](https://code.claude.com/docs/en/changelog#10113)\
\
...
## 1.0.112\
\
[Permalink: 1.0.112](https://code.claude.com/docs/en/changelog#10112)\
\
...
## 1.0.111\
\
[Permalink: 1.0.111](https://code.claude.com/docs/en/changelog#10111)\
\
...
## 1.0.110\
\
[Permalink: 1.0.110](https://code.claude.com/docs/en/changelog#10110)\
\
...
## 1.0.109\
\
[Permalink: 1.0.109](https://code.claude.com/docs/en/changelog#10109)\
\
- SDK: Added partial message streaming support via `--include-partial-messages` CLI flag\
\
## 1.0.106\
\
[Permalink: 1.0.106](https://code.claude.com/docs/en/changelog#10106)\
\
- Windows: Fixed path permission matching to consistently use POSIX format (e.g., `Read(//c/Users/...)`)\
\
## 1.0.97\
\
[Permalink: 1.0.97](https://code.claude.com/docs/en/changelog#1097)\
\
- Settings: /doctor now validates permission rule syntax and suggests corrections\
\
## 1.0.94\
\
[Permalink: 1.0.94](https://code.claude.com/docs/en/changelog#1094)\
\
...
## 1.0.93\
\
[Permalink: 1.0.93](https://code.claude.com/docs/en/changelog#1093)\
\
...
## 1.0.90\
\
[Permalink: 1.0.90](https://code.claude.com/docs/en/changelog#1090)\
\
- Settings file changes take effect immediately - no restart required\
\
## 1.0.88\
\
[Permalink: 1.0.88](https://code.claude.com/docs/en/changelog#1088)\
\
...
## 1.0.86\
\
[Permalink: 1.0.86](https://code.claude.com/docs/en/changelog#1086)\
\
...
## 1.0.85\
\
[Permalink: 1.0.85](https://code.claude.com/docs/en/changelog#1085)\
\
...
## 1.0.84\
\
[Permalink: 1.0.84](https://code.claude.com/docs/en/changelog#1084)\
\
...
## 1.0.83\
\
[Permalink: 1.0.83](https://code.claude.com/docs/en/changelog#1083)\
\
...
## 1.0.82\
\
[Permalink: 1.0.82](https://code.claude.com/docs/en/changelog#1082)\
\
...
## 1.0.81\
\
[Permalink: 1.0.81](https://code.claude.com/docs/en/changelog#1081)\
\
...
## 1.0.80\
\
[Permalink: 1.0.80](https://code.claude.com/docs/en/changelog#1080)\
\
- UI improvements: Fix text contrast for custom subagent colors and spinner rendering issues\
\
## 1.0.77\
\
[Permalink: 1.0.77](https://code.claude.com/docs/en/changelog#1077)\
\
...
## 1.0.73\
\
[Permalink: 1.0.73](https://code.claude.com/docs/en/changelog#1073)\
\
...
## 1.0.72\
\
[Permalink: 1.0.72](https://code.claude.com/docs/en/changelog#1072)\
\
- Ask permissions: have Claude Code always ask for confirmation to use specific tools with /permissions\
\
## 1.0.71\
\
[Permalink: 1.0.71](https://code.claude.com/docs/en/changelog#1071)\
\
...
## 1.0.70\
\
[Permalink: 1.0.70](https://code.claude.com/docs/en/changelog#1070)\
\
...
## 1.0.69\
\
[Permalink: 1.0.69](https://code.claude.com/docs/en/changelog#1069)\
\
- Upgraded Opus to version 4.1\
\
## 1.0.68\
\
[Permalink: 1.0.68](https://code.claude.com/docs/en/changelog#1068)\
\
...
## 1.0.65\
\
[Permalink: 1.0.65](https://code.claude.com/docs/en/changelog#1065)\
\
...
## 1.0.64\
\
[Permalink: 1.0.64](https://code.claude.com/docs/en/changelog#1064)\
\
...
## 1.0.63\
\
[Permalink: 1.0.63](https://code.claude.com/docs/en/changelog#1063)\
\
- Windows: Fixed file search, @agent mentions, and custom slash commands functionality\
\
## 1.0.62\
\
[Permalink: 1.0.62](https://code.claude.com/docs/en/changelog#1062)\
\
...
## 1.0.61\
\
[Permalink: 1.0.61](https://code.claude.com/docs/en/changelog#1061)\
\
...
## 1.0.60\
\
[Permalink: 1.0.60](https://code.claude.com/docs/en/changelog#1060)\
\
- You can now create custom subagents for specialized tasks! Run /agents to get started\
\
## 1.0.59\
\
[Permalink: 1.0.59](https://code.claude.com/docs/en/changelog#1059)\
\
...
## 1.0.58\
\
[Permalink: 1.0.58](https://code.claude.com/docs/en/changelog#1058)\
\
...
## 1.0.57\
\
[Permalink: 1.0.57](https://code.claude.com/docs/en/changelog#1057)\
\
...
## 1.0.56\
\
[Permalink: 1.0.56](https://code.claude.com/docs/en/changelog#1056)\
\
...
## 1.0.55\
\
[Permalink: 1.0.55](https://code.claude.com/docs/en/changelog#1055)\
\
...
## 1.0.54\
\
[Permalink: 1.0.54](https://code.claude.com/docs/en/changelog#1054)\
\
...
## 1.0.53\
\
[Permalink: 1.0.53](https://code.claude.com/docs/en/changelog#1053)\
\
...
## 1.0.52\
\
[Permalink: 1.0.52](https://code.claude.com/docs/en/changelog#1052)\
\
- Added support for MCP server instructions\
\
## 1.0.51\
\
[Permalink: 1.0.51](https://code.claude.com/docs/en/changelog#1051)\
\
...
## 1.0.48\
\
[Permalink: 1.0.48](https://code.claude.com/docs/en/changelog#1048)\
\
...
## 1.0.45\
\
[Permalink: 1.0.45](https://code.claude.com/docs/en/changelog#1045)\
\
...
## 1.0.44\
\
[Permalink: 1.0.44](https://code.claude.com/docs/en/changelog#1044)\
\
...
## 1.0.43\
\
[Permalink: 1.0.43](https://code.claude.com/docs/en/changelog#1043)\
\
...
## 1.0.42\
\
[Permalink: 1.0.42](https://code.claude.com/docs/en/changelog#1042)\
\
- Added tilde (`~`) expansion support to `/add-dir` command\
\
## 1.0.41\
\
[Permalink: 1.0.41](https://code.claude.com/docs/en/changelog#1041)\
\
...
## 1.0.40\
\
[Permalink: 1.0.40](https://code.claude.com/docs/en/changelog#1040)\
\
- Fixed a bug causing API connection errors with UNABLE\_TO\_GET\_ISSUER\_CERT\_LOCALLY if `NODE_EXTRA_CA_CERTS` was set\
\
## 1.0.39\
\
[Permalink: 1.0.39](https://code.claude.com/docs/en/changelog#1039)\
\
- New Active Time metric in OpenTelemetry logging\
\
## 1.0.38\
\
[Permalink: 1.0.38](https://code.claude.com/docs/en/changelog#1038)\
\
- Released hooks. Special thanks to community input in [#712](https://github.com/anthropics/claude-code/issues/712). Docs: [https://code.claude.com/docs/en/hooks](https://code.claude.com/docs/en/hooks)\
\
## 1.0.37\
\
[Permalink: 1.0.37](https://code.claude.com/docs/en/changelog#1037)\
\
- Remove ability to set `Proxy-Authorization` header via ANTHROPIC\_AUTH\_TOKEN or apiKeyHelper\
\
## 1.0.36\
\
[Permalink: 1.0.36](https://code.claude.com/docs/en/changelog#1036)\
\
...
## 1.0.35\
\
[Permalink: 1.0.35](https://code.claude.com/docs/en/changelog#1035)\
\
- Added support for MCP OAuth Authorization Server discovery\
\
## 1.0.34\
\
[Permalink: 1.0.34](https://code.claude.com/docs/en/changelog#1034)\
\
- Fixed a memory leak causing a MaxListenersExceededWarning message to appear\
\
## 1.0.33\
\
[Permalink: 1.0.33](https://code.claude.com/docs/en/changelog#1033)\
\
...
## 1.0.32\
\
[Permalink: 1.0.32](https://code.claude.com/docs/en/changelog#1032)\
\
...
## 1.0.31\
\
[Permalink: 1.0.31](https://code.claude.com/docs/en/changelog#1031)\
\
- Fixed a bug where ~/.claude.json would get reset when file contained invalid JSON\
\
## 1.0.30\
\
[Permalink: 1.0.30](https://code.claude.com/docs/en/changelog#1030)\
\
...
## 1.0.29\
\
[Permalink: 1.0.29](https://code.claude.com/docs/en/changelog#1029)\
\
- Improved CJK character support in cursor navigation and rendering\
\
## 1.0.28\
\
[Permalink: 1.0.28](https://code.claude.com/docs/en/changelog#1028)\
\
...
## 1.0.27\
\
[Permalink: 1.0.27](https://code.claude.com/docs/en/changelog#1027)\
\
...
## 1.0.25\
\
[Permalink: 1.0.25](https://code.claude.com/docs/en/changelog#1025)\
\
...
## 1.0.24\
\
[Permalink: 1.0.24](https://code.claude.com/docs/en/changelog#1024)\
\
- Improved /mcp output\
...
## 1.0.23\
\
[Permalink: 1.0.23](https://code.claude.com/docs/en/changelog#1023)\
\
...
## 1.0.22\
\
[Permalink: 1.0.22](https://code.claude.com/docs/en/changelog#1022)\
\
- SDK: Renamed `total_cost` to `total_cost_usd`\
\
## 1.0.21\
\
[Permalink: 1.0.21](https://code.claude.com/docs/en/changelog#1021)\
\
...
## 1.0.18\
\
[Permalink: 1.0.18](https://code.claude.com/docs/en/changelog#1018)\
\
...
## 1.0.17\
\
[Permalink: 1.0.17](https://code.claude.com/docs/en/changelog#1017)\
\
...
## 1.0.11\
\
[Permalink: 1.0.11](https://code.claude.com/docs/en/changelog#1011)\
\
...
## 1.0.10\
\
[Permalink: 1.0.10](https://code.claude.com/docs/en/changelog#1010)\
\
...
## 1.0.8\
\
[Permalink: 1.0.8](https://code.claude.com/docs/en/changelog#108)\
\
...
## 1.0.7\
\
[Permalink: 1.0.7](https://code.claude.com/docs/en/changelog#107)\
\
...
## 1.0.6\
\
[Permalink: 1.0.6](https://code.claude.com/docs/en/changelog#106)\
\
...
## 1.0.4\
\
[Permalink: 1.0.4](https://code.claude.com/docs/en/changelog#104)\
\
- Fixed a bug where MCP tool errors weren't being parsed correctly\
\
## 1.0.1\
\
[Permalink: 1.0.1](https://code.claude.com/docs/en/changelog#101)\
\
...
## 1.0.0\
\
[Permalink: 1.0.0](https://code.claude.com/docs/en/changelog#100)\
\
...
## 0.2.125\
\
[Permalink: 0.2.125](https://code.claude.com/docs/en/changelog#02125)\
\
...
## 0.2.117\
\
[Permalink: 0.2.117](https://code.claude.com/docs/en/changelog#02117)\
\
...
## 0.2.108\
\
[Permalink: 0.2.108](https://code.claude.com/docs/en/changelog#02108)\
\
...
## 0.2.107\
\
[Permalink: 0.2.107](https://code.claude.com/docs/en/changelog#02107)\
\
- CLAUDE.md files can now import other files. Add @path/to/file.md to ./CLAUDE.md to load additional files on launch\
\
## 0.2.106\
\
[Permalink: 0.2.106](https://code.claude.com/docs/en/changelog#02106)\
\
...
## 0.2.105\
\
[Permalink: 0.2.105](https://code.claude.com/docs/en/changelog#02105)\
\
...
## 0.2.102\
\
[Permalink: 0.2.102](https://code.claude.com/docs/en/changelog#02102)\
\
...
## 0.2.100\
\
[Permalink: 0.2.100](https://code.claude.com/docs/en/changelog#02100)\
\
...
## 0.2.98\
\
[Permalink: 0.2.98](https://code.claude.com/docs/en/changelog#0298)\
\
- Fixed an issue where auto-compact was running twice\
\
## 0.2.96\
\
[Permalink: 0.2.96](https://code.claude.com/docs/en/changelog#0296)\
\
- Claude Code can now also be used with a Claude Max subscription ( [https://claude.ai/upgrade](https://claude.ai/upgrade))\
\
## 0.2.93\
\
[Permalink: 0.2.93](https://code.claude.com/docs/en/changelog#0293)\
\
...
## 0.2.82\
\
[Permalink: 0.2.82](https://code.claude.com/docs/en/changelog#0282)\
\
...
## 0.2.75\
\
[Permalink: 0.2.75](https://code.claude.com/docs/en/changelog#0275)\
\
...
## 0.2.74\
\
[Permalink: 0.2.74](https://code.claude.com/docs/en/changelog#0274)\
\
...
## 0.2.72\
\
[Permalink: 0.2.72](https://code.claude.com/docs/en/changelog#0272)\
\
- Updated spinner to indicate tokens loaded and tool usage\
\
## 0.2.70\
\
[Permalink: 0.2.70](https://code.claude.com/docs/en/changelog#0270)\
\
...
## 0.2.69\
\
[Permalink: 0.2.69](https://code.claude.com/docs/en/changelog#0269)\
\
...
## 0.2.67\
\
[Permalink: 0.2.67](https://code.claude.com/docs/en/changelog#0267)\
\
- Shared project permission rules can be saved in .claude/settings.json\
\
## 0.2.66\
\
[Permalink: 0.2.66](https://code.claude.com/docs/en/changelog#0266)\
\
...
## 0.2.63\
\
[Permalink: 0.2.63](https://code.claude.com/docs/en/changelog#0263)\
\
- Fixed an issue where MCP tools were loaded twice, which caused tool call errors\
\
## 0.2.61\
\
[Permalink: 0.2.61](https://code.claude.com/docs/en/changelog#0261)\
\
...
## 0.2.59\
\
[Permalink: 0.2.59](https://code.claude.com/docs/en/changelog#0259)\
\
...
## 0.2.54\
\
[Permalink: 0.2.54](https://code.claude.com/docs/en/changelog#0254)\
\
...
## 0.2.53\
\
[Permalink: 0.2.53](https://code.claude.com/docs/en/changelog#0253)\
\
...
## 0.2.50\
\
[Permalink: 0.2.50](https://code.claude.com/docs/en/changelog#0250)\
\
- New MCP "project" scope now allows you to add MCP servers to .mcp.json files and commit them to your repository\
\
## 0.2.49\
\
[Permalink: 0.2.49](https://code.claude.com/docs/en/changelog#0249)\
\
- Previous MCP server scopes have been renamed: previous "project" scope is now "local" and "global" scope is now "user"\
\
## 0.2.47\
\
[Permalink: 0.2.47](https://code.claude.com/docs/en/changelog#0247)\
\
...
## 0.2.44\
\
[Permalink: 0.2.44](https://code.claude.com/docs/en/changelog#0244)\
\
- Ask Claude to make a plan with thinking mode: just say 'think' or 'think harder' or even 'ultrathink'\
\
## 0.2.41\
\
[Permalink: 0.2.41](https://code.claude.com/docs/en/changelog#0241)\
\
...
## 0.2.37\
\
[Permalink: 0.2.37](https://code.claude.com/docs/en/changelog#0237)\
\
...
## 0.2.36\
\
[Permalink: 0.2.36](https://code.claude.com/docs/en/changelog#0236)\
\
...
## 0.2.34\
\
[Permalink: 0.2.34](https://code.claude.com/docs/en/changelog#0234)\
\
- Vim bindings for text input - enable with /vim or /config\
\
## 0.2.32\
\
[Permalink: 0.2.32](https://code.claude.com/docs/en/changelog#0232)\
\
...
## 0.2.31\
\
[Permalink: 0.2.31](https://code.claude.com/docs/en/changelog#0231)\
\
...
## 0.2.30\
\
[Permalink: 0.2.30](https://code.claude.com/docs/en/changelog#0230)\
\
...
## 0.2.26\
\
[Permalink: 0.2.26](https://code.claude.com/docs/en/changelog#0226)\
\
...
## 0.2.21\
\
[Permalink: 0.2.21](https://code.claude.com/docs/en/changelog#0221)\
\
