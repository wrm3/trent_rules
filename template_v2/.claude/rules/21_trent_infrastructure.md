...
- `SYSTEM_EXPERIMENTS.md` - Stub → see IDEA_BOARD.md § System Experiments
- `IDEA_BOARD.md` - Ideas + system experiments (human + AI sections + experiment log)
- `HYPOTHESIS.md` - Research hypotheses (research projects only)
- `PROJECT_GOALS.md` - Stub → see PROJECT_CONTEXT.md § Project Goals
...
- `.trent/SYSTEM_EXPERIMENTS.md` - Stub redirect to IDEA_BOARD.md
- `.trent/IDEA_BOARD.md` - Ideas + system experiments (merged template)
- `.trent/PROJECT_GOALS.md` - Stub redirect to PROJECT_CONTEXT.md
