...
Goals: G-01: [name] | G-02: [name]  (from PROJECT_CONTEXT.md § Project Goals)
...
| 27 | `27_trent_self_improvement` | System issue detection, experiment log in IDEA_BOARD |
...
| 30 | `30_trent_ideas_goals` | IDEA_BOARD.md (ideas + experiments) and PROJECT_CONTEXT.md (goals) |
...
├── IDEA_BOARD.md             # Ideas + system experiments (human + AI + experiment log)
