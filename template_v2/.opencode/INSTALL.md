...
```
Fetch and follow instructions from: https://raw.githubusercontent.com/FSTrent/trent_rules/main/.opencode/INSTALL.md
```

## What Gets Installed

trent gives your OpenCode environment:
