[Skip to main content](https://ai.google.dev/gemini-api/docs/thought-signatures#main-content)
...
- [English](https://ai.google.dev/gemini-api/docs/thought-signatures)
- [Deutsch](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=de)
- [Español – América Latina](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=es-419)
- [Français](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=fr)
- [Indonesia](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=id)
- [Italiano](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=it)
- [Polski](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=pl)
- [Português – Brasil](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=pt-br)
- [Shqip](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=sq)
- [Tiếng Việt](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=vi)
- [Türkçe](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=tr)
- [Русский](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=ru)
- [עברית](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=he)
- [العربيّة](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=ar)
- [فارسی](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=fa)
- [हिंदी](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=hi)
- [বাংলা](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=bn)
- [ภาษาไทย](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=th)
- [中文 – 简体](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=zh-cn)
- [中文 – 繁體](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=zh-tw)
- [日本語](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=ja)
- [한국어](https://ai.google.dev/gemini-api/docs/thought-signatures?hl=ko)
...
[Sign in](https://ai.google.dev/_d/signin?continue=https%3A%2F%2Fai.google.dev%2Fgemini-api%2Fdocs%2Fthought-signatures&prompt=select_account)

- On this page
- [How it works](https://ai.google.dev/gemini-api/docs/thought-signatures#how_it_works)
- [Signatures in function calling parts](https://ai.google.dev/gemini-api/docs/thought-signatures#function-calling)
  - [Sequential function calling example](https://ai.google.dev/gemini-api/docs/thought-signatures#sequential_function_calling_example)
  - [Parallel function calling example](https://ai.google.dev/gemini-api/docs/thought-signatures#parallel_function_calling_example)
- [Signatures in non functionCall parts](https://ai.google.dev/gemini-api/docs/thought-signatures#non-function-call)
  - [Text/In-context reasoning (No validation)](https://ai.google.dev/gemini-api/docs/thought-signatures#textin-context_reasoning_no_validation)
- [Signatures for OpenAI compatibility](https://ai.google.dev/gemini-api/docs/thought-signatures#openai)
  - [Sequential function calling example](https://ai.google.dev/gemini-api/docs/thought-signatures#sequential_function_calling_example_2)
  - [Parallel function calling example](https://ai.google.dev/gemini-api/docs/thought-signatures#parallel_function_calling_example_2)
- [FAQs](https://ai.google.dev/gemini-api/docs/thought-signatures#faqs)
- [Thought signatures for different models](https://ai.google.dev/gemini-api/docs/thought-signatures#model-behavior)
...
This includes when using the `minimal` [thinking level](https://ai.google.dev/gemini-api/docs/thinking#thinking-levels) setting for Gemini 3
Flash.
...
_This document focuses on handling function calling for Gemini 3 models. Refer_
_to the [model behavior](https://ai.google.dev/gemini-api/docs/thought-signatures#model-behavior) section for discrepancies with 2.5._
...
- When there are [parallel function](https://ai.google.dev/gemini-api/docs/function-calling#parallel_function_calling)
...
| 1 | 3 | `request3 = request2 + (FC2 + signature) + FR2` | `text_output<br>`<br>`(no FCs)` | None |
...
- **Behavior**:
  ...
  - **Parallel Function Calls**: If the model generates parallel function calls
    in a response, the `thought_signature` is attached **only to the first**`functionCall` part. Subsequent `functionCall` parts in the same response will
...
- **If proper signatures are not returned, here is how you will error out**
  - Gemini 3 models: Failure to include
    ...
    - Function call `<Function Call>` in the `<index of contents array>`
      content block is missing a `thought_signature`. For example, _Function_
      _call `FC1` in the `1.` content block is missing a `thought_signature`._
...
| 1 | 3 | `request3 = request2 + FC2 ("book_taxi") + signature + FR2` | `text_output<br>`<br>`(no FCs)` | `None` |
...
| 1 | 2 | request 2 **=** request1 **+** FC1 ("Paris") + signature + FC2 ("London") | text\_output<br>(no FCs) | None |
...
| --- | --- | --- | --- | --- |
| **Turn** | **Step** | **User Request** | **Model Response** | **FunctionResponse** |
| 1 | 1 | `request1="Check the weather in Paris and London"` | `FC1 ("Paris") + signature<br>`<br>`FC2 ("London")` | `FR1` |
| 1 | 2 | `request 2 = request1 + FC1 ("Paris") + signature + FC2 ("London")` | `text_output<br>`<br>`(no FCs)` | `None` |
