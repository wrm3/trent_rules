...
- [English](https://ai.google.dev/gemini-api/docs/prompting-strategies)
- [Deutsch](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=de)
- [Español – América Latina](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=es-419)
- [Français](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=fr)
- [Indonesia](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=id)
- [Italiano](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=it)
- [Polski](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=pl)
- [Português – Brasil](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=pt-br)
- [Shqip](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=sq)
- [Tiếng Việt](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=vi)
- [Türkçe](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=tr)
- [Русский](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=ru)
- [עברית](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=he)
- [العربيّة](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=ar)
- [فارسی](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=fa)
- [हिंदी](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=hi)
- [বাংলা](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=bn)
- [ภาษาไทย](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=th)
- [中文 – 简体](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=zh-cn)
- [中文 – 繁體](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=zh-tw)
- [日本語](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=ja)
- [한국어](https://ai.google.dev/gemini-api/docs/prompting-strategies?hl=ko)
...
[Sign in](https://ai.google.dev/_d/signin?continue=https%3A%2F%2Fai.google.dev%2Fgemini-api%2Fdocs%2Fprompting-strategies&prompt=select_account)

- On this page
- [Topic-specific prompt guides](https://ai.google.dev/gemini-api/docs/prompting-strategies#additional-prompt-guides)
- [Clear and specific instructions](https://ai.google.dev/gemini-api/docs/prompting-strategies#clear-and-specific-instructions)
  - [Input](https://ai.google.dev/gemini-api/docs/prompting-strategies#input)
  - [Constraints](https://ai.google.dev/gemini-api/docs/prompting-strategies#constraints)
  - [Response format](https://ai.google.dev/gemini-api/docs/prompting-strategies#response-format)
- [Zero-shot vs few-shot prompts](https://ai.google.dev/gemini-api/docs/prompting-strategies#few-shot)
  - [Optimal number of examples](https://ai.google.dev/gemini-api/docs/prompting-strategies#number-examples)
  - [Patterns vs anti patterns](https://ai.google.dev/gemini-api/docs/prompting-strategies#anti-patterns)
  - [Consistent formatting](https://ai.google.dev/gemini-api/docs/prompting-strategies#consistent-formatting)
- [Add context](https://ai.google.dev/gemini-api/docs/prompting-strategies#context)
- [Add prefixes](https://ai.google.dev/gemini-api/docs/prompting-strategies#prefixes)
- [Break down prompts into components](https://ai.google.dev/gemini-api/docs/prompting-strategies#prompt-components)
- [Experiment with model parameters](https://ai.google.dev/gemini-api/docs/prompting-strategies#model-parameters)
- [Prompt iteration strategies](https://ai.google.dev/gemini-api/docs/prompting-strategies#iteration)
- [Fallback responses](https://ai.google.dev/gemini-api/docs/prompting-strategies#fallback-responses)
- [Things to avoid](https://ai.google.dev/gemini-api/docs/prompting-strategies#things-to-avoid)
- [Gemini 3](https://ai.google.dev/gemini-api/docs/prompting-strategies#gemini-3)
  - [Core prompting principles](https://ai.google.dev/gemini-api/docs/prompting-strategies#core_prompting_principles)
  - [Gemini 3 Flash strategies](https://ai.google.dev/gemini-api/docs/prompting-strategies#gemini_3_flash_strategies)
  - [Enhancing reasoning and planning](https://ai.google.dev/gemini-api/docs/prompting-strategies#enhancing_reasoning_and_planning)
  - [Structured prompting examples](https://ai.google.dev/gemini-api/docs/prompting-strategies#structured_prompting_examples)
  - [Example template combining best practices](https://ai.google.dev/gemini-api/docs/prompting-strategies#example_template_combining_best_practices)
- [Agentic workflows](https://ai.google.dev/gemini-api/docs/prompting-strategies#agentic-workflows)
  - [Reasoning and strategy](https://ai.google.dev/gemini-api/docs/prompting-strategies#reasoning_and_strategy)
  - [Execution and reliability](https://ai.google.dev/gemini-api/docs/prompting-strategies#execution_and_reliability)
  - [Interaction and output](https://ai.google.dev/gemini-api/docs/prompting-strategies#interaction_and_output)
  - [System instruction template](https://ai.google.dev/gemini-api/docs/prompting-strategies#agentic-si-template)
- [Generative models under the hood](https://ai.google.dev/gemini-api/docs/prompting-strategies#under-the-hood)
- [Next steps](https://ai.google.dev/gemini-api/docs/prompting-strategies#next-steps)
