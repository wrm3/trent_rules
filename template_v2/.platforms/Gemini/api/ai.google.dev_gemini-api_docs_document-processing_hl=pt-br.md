[Ir para o conteúdo principal](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#main-content)
...
[Fazer login](https://ai.google.dev/_d/signin?continue=https%3A%2F%2Fai.google.dev%2Fgemini-api%2Fdocs%2Fdocument-processing%3Fhl%3Dpt-br&prompt=select_account)

- Nesta página
- [Como transmitir dados de PDF inline](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#inline_data)
- [Fazer upload de PDFs usando a API Files](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#large-pdfs)
  - [PDFs grandes de URLs](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#large-pdfs-urls)
  - [PDFs grandes armazenados localmente](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#large-pdfs-local)
- [Enviar vários PDFs](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#prompt-multiple)
- [Detalhes técnicos](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#technical-details)
  - [Modelos do Gemini 3](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#gemini-3-models)
  - [Tipos de documentos](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#document-types)
  - [Práticas recomendadas](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#best-practices)
- [A seguir](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#whats-next)
...
O exemplo a seguir mostra como buscar um PDF de um URL e convertê-lo em
bytes para processamento:

[Python](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#python)[JavaScript](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#javascript)[Go](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#go)[REST](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#rest)Mais
...
[Python](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#python)[JavaScript](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#javascript)[Go](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#go)Mais
...
[Python](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#python)[REST](https://ai.google.dev/gemini-api/docs/document-processing?hl=pt-br#rest)Mais
...
`media_resolution`. Agora você pode definir a resolução como baixa, média ou alta para cada parte de mídia. Com essa adição, o processamento de documentos em PDF foi atualizado:
