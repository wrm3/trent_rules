[Skip to main content](https://code.claude.com/docs/en/ide-integrations#content-area)
...
- [Prerequisites](https://code.claude.com/docs/en/ide-integrations#prerequisites)
- [Install the extension](https://code.claude.com/docs/en/ide-integrations#install-the-extension)
- [Get started](https://code.claude.com/docs/en/ide-integrations#get-started)
- [Use the prompt box](https://code.claude.com/docs/en/ide-integrations#use-the-prompt-box)
- [Reference files and folders](https://code.claude.com/docs/en/ide-integrations#reference-files-and-folders)
- [Resume past conversations](https://code.claude.com/docs/en/ide-integrations#resume-past-conversations)
- [Resume remote sessions from Claude.ai](https://code.claude.com/docs/en/ide-integrations#resume-remote-sessions-from-claude-ai)
- [Customize your workflow](https://code.claude.com/docs/en/ide-integrations#customize-your-workflow)
- [Choose where Claude lives](https://code.claude.com/docs/en/ide-integrations#choose-where-claude-lives)
- [Run multiple conversations](https://code.claude.com/docs/en/ide-integrations#run-multiple-conversations)
- [Switch to terminal mode](https://code.claude.com/docs/en/ide-integrations#switch-to-terminal-mode)
- [Manage plugins](https://code.claude.com/docs/en/ide-integrations#manage-plugins)
- [Install plugins](https://code.claude.com/docs/en/ide-integrations#install-plugins)
- [Manage marketplaces](https://code.claude.com/docs/en/ide-integrations#manage-marketplaces)
- [Automate browser tasks with Chrome](https://code.claude.com/docs/en/ide-integrations#automate-browser-tasks-with-chrome)
- [VS Code commands and shortcuts](https://code.claude.com/docs/en/ide-integrations#vs-code-commands-and-shortcuts)
- [Configure settings](https://code.claude.com/docs/en/ide-integrations#configure-settings)
- [Extension settings](https://code.claude.com/docs/en/ide-integrations#extension-settings)
- [VS Code extension vs. Claude Code CLI](https://code.claude.com/docs/en/ide-integrations#vs-code-extension-vs-claude-code-cli)
- [Rewind with checkpoints](https://code.claude.com/docs/en/ide-integrations#rewind-with-checkpoints)
- [Run CLI in VS Code](https://code.claude.com/docs/en/ide-integrations#run-cli-in-vs-code)
- [Switch between extension and CLI](https://code.claude.com/docs/en/ide-integrations#switch-between-extension-and-cli)
- [Include terminal output in prompts](https://code.claude.com/docs/en/ide-integrations#include-terminal-output-in-prompts)
- [Monitor background processes](https://code.claude.com/docs/en/ide-integrations#monitor-background-processes)
- [Connect to external tools with MCP](https://code.claude.com/docs/en/ide-integrations#connect-to-external-tools-with-mcp)
- [Work with git](https://code.claude.com/docs/en/ide-integrations#work-with-git)
- [Create commits and pull requests](https://code.claude.com/docs/en/ide-integrations#create-commits-and-pull-requests)
- [Use git worktrees for parallel tasks](https://code.claude.com/docs/en/ide-integrations#use-git-worktrees-for-parallel-tasks)
- [Use third-party providers](https://code.claude.com/docs/en/ide-integrations#use-third-party-providers)
- [Security and privacy](https://code.claude.com/docs/en/ide-integrations#security-and-privacy)
- [Fix common issues](https://code.claude.com/docs/en/ide-integrations#fix-common-issues)
- [Extension won’t install](https://code.claude.com/docs/en/ide-integrations#extension-won%E2%80%99t-install)
- [Spark icon not visible](https://code.claude.com/docs/en/ide-integrations#spark-icon-not-visible)
- [Claude Code never responds](https://code.claude.com/docs/en/ide-integrations#claude-code-never-responds)
- [Uninstall the extension](https://code.claude.com/docs/en/ide-integrations#uninstall-the-extension)
- [Next steps](https://code.claude.com/docs/en/ide-integrations#next-steps)
...
## [​](https://code.claude.com/docs/en/ide-integrations\#prerequisites)  Prerequisites

Before installing, make sure you have:

- VS Code 1.98.0 or higher
- An Anthropic account (you’ll sign in when you first open the extension). If you’re using a third-party provider like Amazon Bedrock or Google Vertex AI, see [Use third-party providers](https://code.claude.com/docs/en/ide-integrations#use-third-party-providers) instead.

The extension includes the CLI (command-line interface), which you can access from VS Code’s integrated terminal for advanced features. See [VS Code extension vs. Claude Code CLI](https://code.claude.com/docs/en/ide-integrations#vs-code-extension-vs-claude-code-cli) for details.

## [​](https://code.claude.com/docs/en/ide-integrations\#install-the-extension)  Install the extension
...
## [​](https://code.claude.com/docs/en/ide-integrations\#get-started)  Get started

Once installed, you can start using Claude Code through the VS Code interface:

1

[Navigate to header](https://code.claude.com/docs/en/ide-integrations#)
...
## [​](https://code.claude.com/docs/en/ide-integrations\#use-the-prompt-box)  Use the prompt box
...
### [​](https://code.claude.com/docs/en/ide-integrations\#reference-files-and-folders)  Reference files and folders
...
### [​](https://code.claude.com/docs/en/ide-integrations\#resume-past-conversations)  Resume past conversations
...
### [​](https://code.claude.com/docs/en/ide-integrations\#resume-remote-sessions-from-claude-ai)  Resume remote sessions from Claude.ai
...
## [​](https://code.claude.com/docs/en/ide-integrations\#customize-your-workflow)  Customize your workflow

Once you’re up and running, you can reposition the Claude panel, run multiple sessions, or switch to terminal mode.

### [​](https://code.claude.com/docs/en/ide-integrations\#choose-where-claude-lives)  Choose where Claude lives
...
### [​](https://code.claude.com/docs/en/ide-integrations\#run-multiple-conversations)  Run multiple conversations
...
### [​](https://code.claude.com/docs/en/ide-integrations\#switch-to-terminal-mode)  Switch to terminal mode
...
## [​](https://code.claude.com/docs/en/ide-integrations\#manage-plugins)  Manage plugins
...
### [​](https://code.claude.com/docs/en/ide-integrations\#install-plugins)  Install plugins
...
### [​](https://code.claude.com/docs/en/ide-integrations\#manage-marketplaces)  Manage marketplaces
...
## [​](https://code.claude.com/docs/en/ide-integrations\#automate-browser-tasks-with-chrome)  Automate browser tasks with Chrome
...
## [​](https://code.claude.com/docs/en/ide-integrations\#vs-code-commands-and-shortcuts)  VS Code commands and shortcuts
...
These are VS Code commands for controlling the extension. Not all built-in Claude Code commands are available in the extension. See [VS Code extension vs. Claude Code CLI](https://code.claude.com/docs/en/ide-integrations#vs-code-extension-vs-claude-code-cli) for details.
...
## [​](https://code.claude.com/docs/en/ide-integrations\#configure-settings)  Configure settings
...
### [​](https://code.claude.com/docs/en/ide-integrations\#extension-settings)  Extension settings
...
## [​](https://code.claude.com/docs/en/ide-integrations\#vs-code-extension-vs-claude-code-cli)  VS Code extension vs. Claude Code CLI
...
### [​](https://code.claude.com/docs/en/ide-integrations\#rewind-with-checkpoints)  Rewind with checkpoints
...
### [​](https://code.claude.com/docs/en/ide-integrations\#run-cli-in-vs-code)  Run CLI in VS Code
...
### [​](https://code.claude.com/docs/en/ide-integrations\#switch-between-extension-and-cli)  Switch between extension and CLI
...
### [​](https://code.claude.com/docs/en/ide-integrations\#include-terminal-output-in-prompts)  Include terminal output in prompts
...
### [​](https://code.claude.com/docs/en/ide-integrations\#monitor-background-processes)  Monitor background processes
...
### [​](https://code.claude.com/docs/en/ide-integrations\#connect-to-external-tools-with-mcp)  Connect to external tools with MCP
...
## [​](https://code.claude.com/docs/en/ide-integrations\#work-with-git)  Work with git
...
### [​](https://code.claude.com/docs/en/ide-integrations\#create-commits-and-pull-requests)  Create commits and pull requests
...
### [​](https://code.claude.com/docs/en/ide-integrations\#use-git-worktrees-for-parallel-tasks)  Use git worktrees for parallel tasks
...
## [​](https://code.claude.com/docs/en/ide-integrations\#use-third-party-providers)  Use third-party providers
...
## [​](https://code.claude.com/docs/en/ide-integrations\#security-and-privacy)  Security and privacy
...
## [​](https://code.claude.com/docs/en/ide-integrations\#fix-common-issues)  Fix common issues

### [​](https://code.claude.com/docs/en/ide-integrations\#extension-won%E2%80%99t-install)  Extension won’t install
...
### [​](https://code.claude.com/docs/en/ide-integrations\#spark-icon-not-visible)  Spark icon not visible
...
### [​](https://code.claude.com/docs/en/ide-integrations\#claude-code-never-responds)  Claude Code never responds
...
## [​](https://code.claude.com/docs/en/ide-integrations\#uninstall-the-extension)  Uninstall the extension
...
## [​](https://code.claude.com/docs/en/ide-integrations\#next-steps)  Next steps
