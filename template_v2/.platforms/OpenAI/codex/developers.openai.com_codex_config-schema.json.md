    ...
    "ModelProviderInfo": {
      ...
      "properties": {
        ...
        "experimental_bearer_token": {
          "description": "Value to use with `Authorization: Bearer ` header. Use of this config is discouraged in favor of `env_key` for security reasons, but this may be necessary when using this programmatically.",
          "type": "string"
        },
        "http_headers": {
          "additionalProperties": {
