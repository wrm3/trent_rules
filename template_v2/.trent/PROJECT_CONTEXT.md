...
- `.trent/IDEA_BOARD.md` — Ideas parking lot (human + AI sections, includes system experiments)

---

## Project Goals

> **Strategic north star.** The AI uses this to validate decisions and steer work.

### Vision
[Replace with 1-2 sentences: what does success look like when this project is done?]
...
### Secondary Goals
- **[Goal name]**: [Description and why it matters]

### Non-Goals (Explicitly Out of Scope)
- [Non-goal 1 — be specific to prevent scope creep]
...
| Date       | Change                  | Reason        |
|------------|-------------------------|---------------|
| YYYY-MM-DD | Initial goals defined   | Project setup |
