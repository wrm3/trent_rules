...
TOOL_NAME = "fstrent_install_cursor"
...
async def execute(
    ...
    logger.info(f"fstrent_install_cursor: target={target}, repo={repo}, dry={dry_run}")
    ...
    result['tool'] = 'fstrent_install_cursor'
